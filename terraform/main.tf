terraform {
  ...
  backend "s3" {
    # Configure backend in terraform/backend.tf or via CLI
...
resource "aws_acm_certificate_validation" "main" {
  certificate_arn = aws_acm_certificate.main.arn
  # In production, you would add Route53 records for validation
  # For this assessment, we'll skip validation or do it manually
}
...
resource "aws_ecs_task_definition" "app" {
  ...
  container_definitions = jsonencode([
    {
      name  = "app"
      image = "${var.container_registry}/${var.container_image}:${var.image_tag}"
